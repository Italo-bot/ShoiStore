...
var product_price = "Precio Producto : $<?php echo $variation_product_price; ?>";

<?php }else{ ?>

var product_price = "Precio Producto : <del> $<?php echo $variation_product_price; ?> </del><br>";

product_price += "Precio Producto de Venta : $<?php echo $variation_product_psp_price; ?>";
...
var product_price = "Precio Paquete : $<?php echo $variation_product_price; ?>";

<?php }else{ ?>

var product_price = "Precio Paquete : <del> $<?php echo $variation_product_price; ?> </del><br>";

product_price += "Precio Paquete de Venta : $<?php echo $variation_product_psp_price; ?>";
...
$(".stock-caption").text("<?php echo $stock_quantity; ?> En Stock");

<?php }elseif($stock_quantity > 0 and $allow_backorders == "notify"){ ?>

$(".stock-caption").text("<?php echo $stock_quantity; ?> En Stock (Encargos Disponibles) ");

<?php }elseif($stock_quantity < 1 and $allow_backorders == "notify"){ ?>

$(".stock-caption").text("Disponible por Encargo");
