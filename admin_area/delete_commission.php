...
alert('Su comisión se eliminó correctamente y el estado de la orden de comisión cambió a: (Procesando) y el proveedor no puede retirar este monto de comisión.');

window.open('index.php?vendors_commissions','_self');
