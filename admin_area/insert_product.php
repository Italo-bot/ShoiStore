...
<i class="fa fa-dashboard"> </i> Dashboard / Agregar Producto
...
<label> Descripción producto (SEO) </label>
...
<label> Fichas de productos </label>

<ul class="nav nav-tabs"><!-- nav nav-tabs Starts -->

<li class="active">

<a data-toggle="tab" href="#description"> Descripción Producto </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Características producto </a>
...
<label> Producto precio de venta </label>
...
<option> Selecccionar una categoría </option>
...
<label> etiquetas producto </label>
...
<option value="notify">Permitir, pero notificar a cliente</option>
...
<a data-toggle="tab" href="#product_attributes"> Atributos de producto </a>
...
<option value="add_variation"> Agregar una nueva variación </option>
