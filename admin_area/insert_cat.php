...
<i class="fa fa-dashboard"></i> Dashboard / Agregar Categoría
...
<i class="fa fa-money fa-fw"></i> Agregar Categoría
...
echo "<script> alert('Se ha insertado una nueva categoría')</script>";
