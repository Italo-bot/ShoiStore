...
<i class="fa fa-dashboard"> </i> Dashboard / Agregar Paquete
...
<label> Precio venta de paquete </label>
...
<label> Seleccionar a Vendedor </label>

<select class="form-control" name="manufacturer"><!-- select manufacturer Starts -->

<option> Selecccionar a Vendedor</option>
...
<option> Seleccionar categoría Paquete </option>
...
<a data-toggle="tab" href="#product_attributes"> Atributos de paquete </a>

</li>

<li>

<a data-toggle="tab" href="#product_variations"> Variaciones de paquete </a>
...
<input type="submit" value="Agregar atributo" class="btn btn btn-primary">
...
<input type="submit" value="Guardar" class="btn btn btn-success">
...
<input type="submit" name="submit" value="Agregar" form="insert_product_form" class="btn btn-primary form-control">
...
echo "<script>alert('La extensión de archivo Imagen 1 no es compatible.')</script>";
...
echo "<script>alert('La extensión de archivo Imagen 2 no es compatible.')</script>";
...
echo "<script>alert('La extensión de archivo Imagen 3 no es compatible.')</script>";
