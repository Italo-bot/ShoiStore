...
<i class="fa fa-dashboard"></i> Dashboard / Editar Relación
...
<i  class="fa fa-money fa-fw"></i> Editar Relación
...
<label class="col-md-3 control-label"> Nombre relación  </label>
...
<input type="submit" name="update" class="btn btn-primary form-control" value="Actualizar">
...
echo "<script>alert('La relación se ha actualizado')</script>";
