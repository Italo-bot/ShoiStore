...
<i class="fa fa-dashboard"></i> Dashboard / Editar Descargable
...
<input type="submit" name="submit" value="Actualizar" class="btn btn-primary form-control"> 
...
alert('Su descarga se ha actualizado correctamente.');
