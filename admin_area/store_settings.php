...
<i class="fa fa-dashboard"></i> Dashboard / Configuración Tienda
...
<input type="submit" name="submit" value="Actualizar" class="btn btn-success form-control">
...
alert(' La configuración de tu tienda se ha actualizado correctamente.');
