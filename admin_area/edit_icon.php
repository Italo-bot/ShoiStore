...
<i class="fa fa-dashboard"> </i> Dashboard / Editar Icono
...
<i class="fa fa-money fa-fw"> </i> Editar Icono
...
<label class="col-md-3 control-label"> Nombre Icono </label>
...
<option> Seleccionar icono para paquetes </option>
...
<label class="col-md-3 control-label"> Seleccionar imagen de icono </label>
...
echo "<script> alert('Se ha actualizado un icono') </script>";
