...
<i class="fa fa-dashboard"> </i> Dashboard / Editar Producto
...
<label> Seleccionar a un Fabricante </label>
...
<option value="notify">Permitir, pero notificar al vendedor</option>
...
<option value="notify" selected>Permitir, pero notificar al vendedor</option>
...
<input type="submit" name="update" value="Actualizar producto" form="edit_product_form" class="btn btn-primary form-control">
