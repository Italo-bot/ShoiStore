...
$product_id = $_GET['approve_product'];
...
alert(' Un producto ha sido aprobado con éxito y está disponible en el sitio web.');
...
alert(' Un paquete ha sido aprobado con éxito y está disponible en el sitio web.');
