...
<i class="fa fa-dashboard"></i> Dashboard / Ver Reseñas
...
<option value=""> Seleccionar reseña de un cliente </option>
...
<option value=""> Seleccionar una reseña de producto/paquete </option>
...
<option value=""> Seleccione una calificación de revisión </option>

<option value="1" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 1){ echo "selected"; } ?>> 1 Estrella </option>

<option value="2" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 2){ echo "selected"; } ?>> 2 Estrellas </option>

<option value="3" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 3){ echo "selected"; } ?>> 3 Estrellas </option>

<option value="4" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 4){ echo "selected"; } ?>> 4 Estrellas </option>

<option value="5" <?php if(isset($_REQUEST["review_rating"]) and $_REQUEST["review_rating"] == 5){ echo "selected"; } ?>> 5 Estrellas </option>
...
todo (<?php get_reviews_status_count("all"); ?>)
...
Pendientes (<?php get_reviews_status_count("pending"); ?>)
...
Aprobados (<?php get_reviews_status_count("active"); ?>)
...
Basura (<?php get_reviews_status_count("trash"); ?>)
...
<th> Revisar producto: </th>

<th> Revisar contenido: </th>

<th> Calificación de revisión: </th>
...
<h3> Lo sentimos, no hemos encontrado ninguna reseña. </h3>
...
Por <span class="text-muted"><?php echo $review_customer_name; ?></span>
...
<i class="fa fa-arrow-left"></i> Restaurar reseña
