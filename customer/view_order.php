...
Estás viendo los detalles completos de este pedido

<mark>#<?php echo $invoice_no; ?></mark> 

fue colocado en <mark><?php echo $order_date; ?></mark> Y tiene actualmente
...
<button type="submit" name="submit"> Escribir una Reseña </button>
