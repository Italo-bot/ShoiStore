...
<p> No hay métodos de envío que coincidan / estén disponibles para su dirección, o contáctenos si necesita ayuda. </p> 
...
<p id="offline_desc" class="text-muted">Realice su pago directamente en nuestra cuenta bancaria o envíe un cheque a Nombre de la tienda, Calle de la tienda, Ciudad de la tienda, Comuna de la tienda, Código postal de la tienda.</p>
...
<p id="paypal_desc" class="text-muted">Pague a través de PayPal, puede pagar con su tarjeta de crédito si no tiene una cuenta de PayPal.</p>
