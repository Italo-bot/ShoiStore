...
<a href="index.php?bundles&product_status=active" class="link-separator <?php echo_active_class("active"); ?> pull-left">
...
<a href="index.php?bundles&product_status=paused" class="link-separator <?php echo_active_class("paused"); ?> pull-left">
...
<a href="index.php?bundles&product_status=pending" class="link-separator <?php echo_active_class("pending"); ?> pull-left">

Pendientes (<?php get_products_status_count("pending"); ?>)

</a>

<a href="index.php?insert_bundle" class="btn btn-success pull-right"> + Insertar nuevo paquete </a>
...
<th colspan="2">Título del paquete</th>
...
<i class="fa fa-pause-circle-o"></i> Pausa
