...
<i class="fa fa-money fa-fw"></i> Ver Descargables
...
<i class="fa fa-gift"></i> Añadir nuevo archivo
...
<th> N° de descargable: </th>

<th> Título de la descargable: </th>
...
<strong>ID de variación: #<?php echo $variation_id; ?></strong>
