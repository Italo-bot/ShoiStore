...
<i class="fa fa-money fa-fw"> </i> Editar Descargable
...
<label class="col-md-3 control-label">Título Descargable</label>
...
<label class="col-md-3 control-label"> Seleccionar Producto/Paquete </label>
...
$get_product = "select * from products where product_id='$edit_product_id' and vendor_id='$customer_id'";
...
<label class="col-md-3 control-label"> Seleccione una variación </label>
...
<label class="col-md-3 control-label">Descargar archivo</label>
...
<input type="submit" name="submit" value="Actualizar Descargable" class="btn btn-primary form-control"> 
...
$update_download = "update downloads set product_id='$product_id',variation_id='$variation_id',download_title='$download_title',download_file='$download_file' where vendor_id='$customer_id' and download_id='$download_id'";
...
alert('Su descargable se ha actualizado correctamente.');
