...
->setEmailSubject("Tiene el pago de Paypal Payout de ShoiStore");
...
alert('Felicidades, tu dinero $$amount Se ha enviado correctamente a su cuenta de Paypal.');
...
alert('Lo sentimos, Se produjo un error durante el envío de su dinero a su cuenta de Paypal.');
...
alert('Su monto ingresado es mayor que su saldo actual.');
...
alert('Su monto ingresado es menor que nuestro monto mínimo de retiro $$minimum_withdraw_limit.');
