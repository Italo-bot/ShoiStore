...
Todo (<?php get_reviews_status_count(""); ?>)

</a>

<a class="link-separator">|</a>

<a href="index.php?reviews&review_status=pending" class="link-separator <?php echo_active_class("pending"); ?>">

Pendiente (<?php get_reviews_status_count("pending"); ?>)

</a>

<a class="link-separator">|</a>

<a href="index.php?reviews&review_status=active" class="link-separator <?php echo_active_class("active"); ?>">

Aprobado (<?php get_reviews_status_count("active"); ?>)

</a>

<a class="link-separator">|</a>

<a href="index.php?reviews&review_status=spam" class="link-separator <?php echo_active_class("spam"); ?>">
...
<br> <span class="text-muted"> Enviado el <?php echo $review_date; ?> </span>
