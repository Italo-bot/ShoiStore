...
<i class="fa fa-money fa-fw"> </i> Agregar descargable
...
<label class="col-md-3 control-label">Nombre descargable</label>
...
<label class="col-md-3 control-label">Archivo Descargable</label>
...
<input type="submit" name="submit" value="Agregar Descargable" class="btn btn-primary form-control">
...
alert('La nueva descarga se ha insertado correctamente.');
