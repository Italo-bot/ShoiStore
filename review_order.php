...
<p> No hay métodos de envío disponibles. Por favor revise su dirección, o contáctenos si necesita ayuda. </p> 
...
<p> No hay métodos de envío que coincidan o estén disponibles para su dirección, contáctenos si necesita ayuda. </p> 
...
<th class="text-muted">Impuesto:</th>
...
<label for="offline"> Pagar Offline </label>
...
<label for="stripe">T. Crédito (Stripe)</label>

<p id="stripe_desc" class="text-muted">
Pague con su tarjeta de crédito a través de Stripe. MODO DE PRUEBA HABILITADO. En el modo de prueba, puede utilizar el número de tarjeta 4242424242424242 con cualquier CVC y una fecha de vencimiento válida o consulte la documentación "Testing Stripe" para obtener más números de tarjeta.</p>
...
Pague a través de PayPal, puede pagar con su tarjeta de crédito si no tiene una cuenta de PayPal.
...
<input type="hidden" name="return" value="http://localhost/shoistore/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total_cart_price; ?>">

<?php }else{ ?>

<input type="hidden" name="return" value="http://localhost/shoistore/paypal_order.php?c_id=<?php echo $customer_id; ?>&amount=<?php echo $total; ?>">

<?php } ?>

<input type="hidden" name="cancel_return" value="http://localhost/shoistore/checkout.php">
