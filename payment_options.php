...
<a href="order.php?c_id=<?php echo $customer_id; ?>">Pagar Offline</a>
...
<input type="hidden" name="return" value="http://localhost/shoistore/paypal_order.php?c_id=<?php echo $customer_id; ?>">

<input type="hidden" name="cancel_return" value="http://localhost/shoistore/index.php">
