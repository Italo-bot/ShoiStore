...
<label class="col-lg-4 col-md-3 control-label" >Cantidad de Paquetes </label>
...
Precio Paquete : <del> $$pro_price </del><br>

Precio Paquete de Venta : $$pro_psp_price
...
Precio : $$variation_product_price
...
Precio : <del> $$variation_product_price </del><br>

Precio de Venta : $$variation_product_psp_price
...
echo "<script>alert('Este producto ya fue agregado a su lista de deseos')</script>";
